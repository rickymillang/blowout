...
@section('content')
	<div class="ibox float-e-margins">
	    ...
	    <div class="ibox-content">
		    ...
		    <form class="form-horizontal" method="POST" action="/venues/{{ $venue->id }}/add-event-types">
				{{ csrf_field() }}
				...
				<div class="form-group">
				    <label for="event_type" class="col-md-2 col-md-offset-2 control-label">Event Type <span class="text-danger">*</span></label>
				    <div class="col-md-6">
