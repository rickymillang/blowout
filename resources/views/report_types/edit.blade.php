...
@section('breadcrumbs')
    ...
    <li class="active">
        <strong>Edit Report Type</strong>
    </li>
@endsection
...
@section('content')
	<div class="ibox float-e-margins">
	    ...
	    <div class="ibox-content">
		    ...
		    <form class="form-horizontal" method="POST" action="/report_types/{{ $report_type->id }}">
				{{ csrf_field() }}
				{{ method_field('PATCH')}}
				<div class="form-group">
					<label for="name" class="col-md-2 col-md-offset-2 control-label">Name <span class="text-danger">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="name" value="{{ $report_type->name }}">
					</div>
				</div>
